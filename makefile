...
linux: rechenspiel.c cFunctions.c setlocale_unices.c
	...
	@mkdir -p ./bin/
	@gcc -o ./bin/rechenspiel.bin rechenspiel.c cFunctions.c setlocale_unices.c
	@strip --strip-unneeded ./bin/rechenspiel.bin
windows: rechenspiel.c cFunctions.c setlocale_win.c
	@echo "Building for Windows x86_64..."
	@mkdir -p ./bin/
	@x86_64-w64-mingw32-gcc -o ./bin/rechenspiel.exe rechenspiel.c cFunctions.c setlocale_win.c
